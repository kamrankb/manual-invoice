                                        ...
                                        <table class="table table">
                                          ...
                                          <tbody>
                                              <tr v-for="(item, index) in invoiceData.items">
                                                  ...
                                                  <td>
                                                    <input type="text" class="form-control" tabindex="3" v-model="item.desc" placeholder="Description" />
                                                    <span class="error" v-if="invoiceData?.errors[`items.${index}.desc`]">{{ invoiceData?.errors[`items.${index}.desc`]?.[0] }}</span>
                                                  </td>
...
const generateInvoiceNumber = (issueDate, id) => {
    ...
    let invoiceNumber = `INV-${invoiceDateString}-${id + 1000}`;
...
function submit() {
  router.post(route('admin.invoice.store'), invoiceData)
}
